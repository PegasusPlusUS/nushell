...
use nu_protocol::{
    ast, byte_stream::copy_with_signals, engine::expand_path_with, process::ChildPipe,
...
impl Command for Save {
    ...
    fn run(
        ...
        let path = Spanned {
            item: expand_path_with(stack, engine_state, path_arg.item, &cwd, true),
            span: path_arg.span,
        };
        ...
        let stderr_path = call
            ...
            .map(|arg| Spanned {
                item: expand_path_with(stack, engine_state, arg.item, cwd, true),
                span: arg.span,
            });
